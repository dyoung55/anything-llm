const TRANSLATIONS = {
  ...
  chat: {
    ...
    mode: {
      ...
      agent: {
        ...
        description: "will route <b>all</b> messages through the agent pipeline regardless of content.<br />No @agent prefix required.",
      },
    },
    history: {
      title: "Chat History",
  ...
  usageAnalytics: {
    title: "Usage",
    description:
      "View chat volume and token usage from workspace chats. Filter by workspace, date, user, and whether the message was sent via the developer API. When the LLM did not store usage metrics, tokens are estimated from the saved prompt and reply text (approximate; encoding may not match your workspace model).",
    exportCsv: "Export CSV",
    exportSuccess: "Usage exported successfully.",
    exportFailed: "Failed to export usage.",
    errorGeneric: "Could not load usage data.",
    ...
    filterUser: "User",
    allUsers: "All users",
    unassignedUser: "No logged-in user",
    filterViaApi: "Source",
    viaApiAll: "All",
    viaApiUi: "UI only",
    viaApiApi: "API only",
    ...
    tokensDisclaimer:
      "Totals combine reported LLM usage where available, otherwise estimates from stored text.",
    chatsWithMetrics: "Chats with reported metrics",
    chatsMissingMetrics: "Chats without reported metrics",
    chatsWithEstimatedTokens: "Chats using estimated tokens",
    chartMetric: "Chart shows",
    metricChats: "Chats sent",
    metricTokens: "Tokens",
    groupBy: "Group by",
    ...
    noRows: "No rows for the selected filters.",
    prev: "Previous",
    next: "Next",
