...
/**
 * Applies D-Mind branding to an Excel workbook.
 * Adds a subtle "Created with D-Mind" text row below the data on each sheet.
...
function applyBranding(workbook) {
  for (const worksheet of workbook.worksheets) {
    ...
    brandingCell.value = "Created with D-Mind";
    brandingCell.font = {
      italic: true,
      size: 9,
      color: { argb: "FF999999" },
